...
# Array representation of a heap (almost-complete binary tree): an element will
# be at index i; its immediate left child will be at i+1, and right child at
# i+2. Root will be at index 0.
